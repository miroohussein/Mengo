      ...
      Row(
        children:[
          ...
          Center(child: Padding(
            ...
            child: Text("Project Sections",style: TextStyle(color: MengoColors.mainOrange,fontSize: 27),),
          )),
          Padding(
                 ...
                 child: Column(
                   children: [
                     Padding(
                       ...
                       child: Text("Single offers Product section:",style: TextStyle(color: MengoColors.mainOrange,fontSize: 20,fontWeight: FontWeight.bold,),),
                     ),
                     Padding(
...
controller: text1,
                     ...
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField(controller: text2,
                     ...
                     Column(children:[
                                   ...
                                   return CircleAvatar(
                                     ...
                                     child:  Padding(
                                       ...
                                       child: Container(   decoration: BoxDecoration(
                                         ...
                                         image:DecorationImage(image: AssetImage("assets/plus.jpg"),fit: BoxFit.cover),)
                                       ),
                                     ),
                                   );
                                 },
                       ...
                       Padding(
                         padding: const EdgeInsets.all(8.0),
                         child: Text('Add image',style: TextStyle(fontSize: 15,color: Colors.black),),
                       ),
                     ],
                     ),
                     ...
                     Padding(
                       padding: const EdgeInsets.only(left: 2,top: 20,),
                       child: Text("Single sales Product section:",style: TextStyle(color: MengoColors.mainOrange,fontSize: 20,fontWeight: FontWeight.bold,),),
                     ),
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField(controller: text3,
                     ...
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField( controller: text4,
                     ...
                     Padding(
                       padding: const EdgeInsets.only(left: 2,top: 20,),
                       child: Text("Category one Product section:",style: TextStyle(color: MengoColors.mainOrange,fontSize: 20,fontWeight: FontWeight.bold,),),
                     ),
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField(controller: text5,
                     ...
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField( controller: text6,
                     ...
                     Padding(
                       padding: const EdgeInsets.only(left: 2,top: 20,),
                       child: Text("Category two Product section:",style: TextStyle(color: MengoColors.mainOrange,fontSize: 20,fontWeight: FontWeight.bold,),),
                     ),
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField(controller: text7,
                     ...
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField( controller: text8,
                     ...
                     Padding(
                       padding: const EdgeInsets.only(left: 2,top: 20,),
                       child: Text("Category three Product section:",style: TextStyle(color: MengoColors.mainOrange,fontSize: 20,fontWeight: FontWeight.bold,),),
                     ),
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField(controller: text9,
                     ...
                     Padding(
                       padding: const EdgeInsets.all(15),
                       child: TextFormField(controller: text0,
