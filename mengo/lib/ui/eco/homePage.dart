        ...
        Row(
          children:[
            ...
            Center(child: Padding(
              ...
              child: Text("Home Page",style: TextStyle(color: MengoColors.mainOrange,fontSize: 27),),
            )),
            Padding(
              padding: const EdgeInsets.only(left: 50),
                               ...
                               child: Row(
                                 ...
                                 children: [
                                     ...
                                     Column(children:[
                                       ...
                                       Padding(
                                         padding: const EdgeInsets.all(8.0),
                                         child: Text('Add category 1 image',style: TextStyle(fontSize: 15,color: Colors.black),),
                                       ),
                                     ],
                                   ),
                                   ...
                                   Column(children:[
                                     ...
                                     Padding(
                                       padding: const EdgeInsets.all(8.0),
                                       child: Text('Add category 2 image',style: TextStyle(fontSize: 15,color: Colors.black),),
                                     ),
                                   ],
                                   ),
                         ...
                         child: Row(
                           ...
                           children: [
                             ...
                             Column(children:[
                               ...
                               Padding(
                                 padding: const EdgeInsets.all(8.0),
                                 child: Text('Add category 3 image',style: TextStyle(fontSize: 15,color: Colors.black),),
                               ),
                             ],
                             ),
                             ...
                             Column(children:[
                                 ...
                                 child: Padding(
                                   ...
                                   child: Container(
                                     ...
                                     child: _pickedImage6 != null
                                         ? ClipRRect(
                                         borderRadius: BorderRadius.circular(30),
                                         child: Image.file(_pickedImage6!))
                                         : image6 != null
                                         ? ClipRRect(
                                       borderRadius:
                                       BorderRadius.circular(500),
                               ...
                               Padding(
                                 padding: const EdgeInsets.all(8.0),
                                 child: Text('  Add offers image      ',style: TextStyle(fontSize: 15,color: Colors.black),),
                               ),
                             ],
                             ),
                         ...
                         child: Row(
                           ...
                           children: [
                             ...
                             Column(children:[
                                 ...
                                 child: Padding(
                                   ...
                                   child: Container(
                                     ...
                                     child: _pickedImage7 != null
                                         ? ClipRRect(
                                         borderRadius: BorderRadius.circular(30),
                                         child: Image.file(_pickedImage7!))
                                         : image7!= null
                                         ? ClipRRect(
                                       borderRadius:
                                       BorderRadius.circular(500),
                               ...
                               Padding(
                                 padding: const EdgeInsets.all(8.0),
                                 child: Text('    Add sales image   ',style: TextStyle(fontSize: 15,color: Colors.black),),
                               ),
                             ],
                             ),
                             ...
                             Column(children:[
                                 ...
                                 child: Padding(
                                   ...
                                   child: Container(
                                     ...
                                     child: _pickedImage8 != null
                                         ? ClipRRect(
                                         borderRadius: BorderRadius.circular(30),
                                         child: Image.file(_pickedImage8!))
                                         : image8 != null
                                         ? ClipRRect(
                                       borderRadius:
                                       BorderRadius.circular(500),
                               ...
                               Padding(
                                 padding: const EdgeInsets.all(8.0),
                                 child: Text('Add first home image',style: TextStyle(fontSize: 15,color: Colors.black),),
                               ),
                             ],
                             ),
                         ...
                         child: Row(
                           ...
                           children: [
                             ...
                             Column(children:[
                                 ...
                                 child: Padding(
                                   ...
                                   child: Container(
                                     ...
                                     child: _pickedImage9 != null
                                         ? ClipRRect(
                                         borderRadius: BorderRadius.circular(30),
                                         child: Image.file(_pickedImage9!))
                                         : image9 != null
                                         ? ClipRRect(
                                       borderRadius:
                                       BorderRadius.circular(500),
                               ...
                               Padding(
                                 padding: const EdgeInsets.all(8.0),
                                 child: Text('   Add second home image   ',style: TextStyle(fontSize: 12,color: Colors.black),),
                               ),
                             ],
                             ),
                             ...
                             Column(children:[
                                 ...
                                 child: Padding(
                                   ...
                                   child: Container(
                                     ...
                                     child: _pickedImage0 != null
                                         ? ClipRRect(
                                         borderRadius: BorderRadius.circular(30),
                                         child: Image.file(_pickedImage0!))
                                         : image0 != null
                                         ? ClipRRect(
                                       borderRadius:
                                       BorderRadius.circular(500),
                               ...
                               Padding(
                                 padding: const EdgeInsets.all(8.0),
                                 child: Text('  Add about image      ',style: TextStyle(fontSize: 15,color: Colors.black),),
                               ),
                             ],
                             ),
